    ...
    return (
        <div className="scs-home-hero-panel-1-wrapper-2">
            ...
            <div className="parent">
                <a className="div1" href="https://www.soccercapitalsummer.com/tickets">tickets<span className="material-symbols-outlined">
                    arrow_right_alt
                </span></a>
                <a className="div2" href="https://www.soccercapitalsummer.com/experience">experiences<span className="material-symbols-outlined">
                    arrow_right_alt
                </span></a>
                <a className="div3" href="https://www.soccercapitalsummer.com/concerts">concerts<span className="material-symbols-outlined">
                    arrow_right_alt
                </span></a>
                <a className="div4" href="https://www.soccercapitalsummer.com/schedule">schedule<span className="material-symbols-outlined">
                    arrow_right_alt
                </span></a>
            </div>
